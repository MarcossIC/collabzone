...
export const IDENTITY_VAL_ERRORS = {
    PASSWORD_INVALID: "La contraseña debe tener al menos 8 caracteres, incluyendo una letra mayúscula, una letra minúscula, un número y un carácter especial",
    ...
    PASSWORD_LENGTH: "La contraseña debe tener al menos 8 caracteres y como maximo 40 caracteres.",
    EMAIL_INVALID: "El correo electrónico es inválido.",
    EMAIL_REQUIRED: "El correo electrónico es obligatorio.",
    EMAIL_LENGTH: "El correo electrónico debe tener al menos 5 caracteres y como maximo 255 caracteres.",
    NAME_REQUIRED: "El nombre es obligatorio.",
    LASTNAME_REQUIRED: "El apellido es obligatorio.",
    NAME_LENGTH: "El nombre debe tener al menos 1 caracter y como maximo 60 caracteres.",
    LASTNAME_LENGTH: "El apellido debe tener al menos 1 caracter y como maximo 60 caracteres.",
...
export const IDENTITY_ERRORS = {
    ...
    USER_ID_MISMATCH: "Tu ID de usuario no coincide con el identificador de usuario.",
    AUTH_PROVIDER_ERROR: "Error al crear el proveedor de autenticación",
    USER_PASSWORD_CHANGED: "Tu contraseña ha sido cambiado",
    USER_UNCONFIRMED: "Verifica tu correo electronico, te hemos enviado un correo de confirmacion.",
...
export const IDENTITY_SUCCESS = {
    USER_CREATED: "Tu cuenta ha sido creada. Te hemos enviado un correo de confirmación.",
